...
<div class="row">
  <div class="span8 offset1">
    <h2>Oups... Erreur <span class="text-error">404</span> !</h2>
    <h3>Le document que vous cherchez est introuvable.</h3>
    <div class="espace">
      <p class="lead">
        Il se trouve que vous vous êtes perdu(e) dans l’Internet !
        <br />C’est embêtant, mais voyons ensemble comment corriger ça :)
      </p>
    </div>
  </div>
