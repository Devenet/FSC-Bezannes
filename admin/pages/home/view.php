<div class="tabbable">
  <ul class="nav nav-tabs">
    <li class="active"><a href="#tab-activities" data-toggle="tab"><i class="icon-globe"></i> Activités</a></li>
    <li><a href="#tab-members" data-toggle="tab"><i class="icon-user"></i> Membres</a></li>
    <li><a href="#tab-preinscriptions" data-toggle="tab"><i class="icon-list-alt"></i> Préinscriptions</a></li>
    <li class="pull-right"><a href="#tab-history" data-toggle="tab"><i class="icon-list-alt"></i> Historique</a></li>
    <li class="pull-right"><a href="#tab-config" data-toggle="tab"><i class="icon-cog"></i> Configuration</a></li>
  </ul>
