...
$act->setDescription('<p>La bibliothèque, riche de près de 6000 ouvrages, albums, documentaires, romans, bandes dessinées, biographies propose régulièrement les nouveautés littéraires. Des titres pour tous les âges et toutes les envies de lecture.</p><p>Des animations autour du livre sont régulièrement proposées le mercredi matin à destination des plus jeunes lecteurs.</p><p>Intégrée au réseau national de « Culture et Bibliothèque Pour Tous », le choix des livres est réalisé grâce aux conseils avisés des comités de lecture (enfants – ados – adultes) auxquels participent activement les bibliothécaires.</p><p>Les bibliothécaires sont tous des bénévoles. Vous voulez rejoindre l’équipe ? N’hésitez pas... <br />Prenez contact avec la bibliothèque !</p>');
