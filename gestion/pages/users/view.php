<div class="row">
  ...
  <div class="span7">
    <h3>Utilisateurs <span class="pull-right" style="font-weight:normal;"><a href="<?php echo _GESTION_; ?>/?page=edit-users&amp;action=new" class="btn btn-small btn-primary"><i class="icon-plus icon-white"></i> Ajouter</a></span></h3>
...
<div id="change-password" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="modalChangePassword" aria-hidden="true">
  ...
  <form method="post" action="<?php echo _GESTION_; ?>/?page=users" class="form form-horizontal" style="margin-bottom:0;">
