...
abstract class Upload {
  ...
  public function save($name = null, $path = null) {
    $this->path = '..' . DIRECTORY_SEPARATOR . _PATH_PUBLIC_ . DIRECTORY_SEPARATOR . _PATH_UPLOADS_ . DIRECTORY_SEPARATOR . (is_null($path) ? $this->files : preg_replace('#(.*)/$#', '$1', $path)) . DIRECTORY_SEPARATOR;
