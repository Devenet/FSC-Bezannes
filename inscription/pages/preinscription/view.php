  ...
  <div class="span8">   
    <div class="tabbable">
      <ul class="nav nav-tabs">
        ...
        <?php echo ($m->adherent() ? '<li class="pull-right"><a href="#tab-activities" id="link-tab-activities" data-toggle="tab"><i class="icon-globe"></i> Activités <span class="label label-info">'. $count_activites .'</span></a></li>' : null); ?>
      </ul>
